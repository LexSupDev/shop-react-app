          ...
          <div className="wrap">
            ...
            <div className="w-full border border-gray-200 rounded-2xl py-5 px-6">
              <div className="flex flex-row border-b-1 border-gray-200 last:border-none last:pb-0 pb-6 mt-6 first:mt-0 gap-4">
                <img src="src/assets/t-shirt-1.jpg" alt="" className="w-31 h-31" />
                <div className="flex justify-between w-full">
                  <div className="flex flex-col justify-between">
                    ...
                    <div className="mt-[-20px]">
                      <p className="text-sm">Size: <span className="text-gray-400">Large</span></p>
                      <p className="text-sm">Color: <span className="text-gray-400">White</span></p>
                    </div>
